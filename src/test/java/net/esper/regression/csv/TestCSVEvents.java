package net.esper.regression.csv;
...
import net.esper.csv.CSVAdapter;
import net.esper.csv.CSVAdapterGroup;
import net.esper.csv.CSVAdapterSpec;
import net.esper.csv.MapEventSpec;
...
public class TestCSVEvents extends TestCase
{
	...
	protected void setUp() throws ClassNotFoundException
	{
		...
		configuration.addMapEvent(eventTypeAlias, propertyTypeNames);
