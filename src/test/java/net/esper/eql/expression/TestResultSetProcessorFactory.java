...
public class TestResultSetProcessorFactory extends TestCase
{
    ...
    public void testGetProcessorNoProcessorRequired() throws Exception
    {
        ...
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(wildcardSelect, groupByList, null, typeService1Stream, null);
    ...
    public void testGetProcessorSimpleSelect() throws Exception
    {
        ...
        List<SelectExprElement> wildcardSelect = new LinkedList<SelectExprElement>();
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(wildcardSelect, groupByList, null, typeService3Stream, null);
        ...
        processor = ResultSetProcessorFactory.getProcessor(selectList, groupByList, null, typeService1Stream, null);
        assertTrue(processor instanceof ResultSetProcessorSimple);
        ...
        processor = ResultSetProcessorFactory.getProcessor(wildcardSelect, groupByList, null, typeService1Stream, null);
        assertTrue(processor instanceof ResultSetProcessorSimple);
    }
    ...
    public void testGetProcessorAggregatingAll() throws Exception
    {
        ...
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(selectList, groupByList, null, typeService1Stream, null);
    ...
    public void testGetProcessorInvalid() throws Exception
    {
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(SupportSelectExprFactory.makeInvalidSelectList(), groupByList, null, typeService3Stream, null);
            fail();
        }
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(SupportSelectExprFactory.makeNoAggregateSelectList(), groupByList, null, typeService3Stream, null);
            fail();
        }
        catch (ExprValidationException ex)
        {
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(selectList, groupByList, null, typeService3Stream, null);
            fail();
        }
        catch (ExprValidationException ex)
        {
