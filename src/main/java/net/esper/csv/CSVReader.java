...
public class CSVReader
{
	 ...
	 */
	public CSVReader(String path, boolean isLooping) throws CSVAdapterException
	{
		this.path = path;
	 ...
	 */
	public void close() throws CSVAdapterException
	{
		if(isClosed)
		{
	 ...
	 */
	public String[] getNextRecord() throws EOFException, CSVAdapterException
	{
		try
		{
