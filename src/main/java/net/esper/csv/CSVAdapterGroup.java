...
{
	private final List<CSVAdapter> adapters = new ArrayList<CSVAdapter>();
	private final CSVTimer timer = new CSVTimer();
	 ...
	 */
	public void addNewAdapter(CSVAdapterSpec adapterSpec, MapEventSpec mapSpec) throws CSVAdapterException
	{
