...
public abstract class AbstractCoordinatedAdapter implements CoordinatedAdapter
{
	...
	private void scheduleNextCallback()
	{
        ...
        EPStatementHandleCallback scheduleCSVHandle = new EPStatementHandleCallback(new EPStatementHandle(new ManagedLockImpl("CSV"), "AbstractCoordinatedAdapter", false), nextScheduleCallback);
