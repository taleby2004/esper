 ...
 */
public final class EvalFollowedByStateNodeManaged extends EvalStateNode implements Evaluator
{
     ...
     */
    public EvalFollowedByStateNodeManaged(Evaluator parentNode,
