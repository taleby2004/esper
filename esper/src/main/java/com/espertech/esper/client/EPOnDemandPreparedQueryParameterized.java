...
/**
 * Parameterer holder for parameterized on-demand queries that are prepared with substitution parameters and that
 * can be executed efficiently multiple times with different actual values for parameters.
 * <p>
 * A precompiled query can only be executed when actual values for all
