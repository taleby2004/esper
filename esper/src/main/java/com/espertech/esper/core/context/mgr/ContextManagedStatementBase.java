...
public abstract class ContextManagedStatementBase {
    ...
    public ContextManagedStatementBase(StatementSpecCompiled statementSpec, StatementContext statementContext, ContextMergeView mergeView, StatementAgentInstanceFactory factory) {
