...
public class StatementAgentInstanceUtil {
    ...
    public static StatementAgentInstanceFactoryResult start(EPServicesContext servicesContext,
                                                     ContextManagedStatementBase statement,
                                                     boolean isSingleInstanceContext,
                                                     int agentInstanceId,
                                                     EventBean agentInstanceProperties,
                                                     AgentInstanceFilterProxy agentInstanceFilterProxy)
    {
        ...
        if (isSingleInstanceContext) {
            ...
            agentInstanceLock = servicesContext.getStatementLockFactory().getStatementLock(statementContext.getStatementName(), statementContext.getExpression(), statementContext.getAnnotations());
        }
